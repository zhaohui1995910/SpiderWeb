...
# SqlServer
# MSSQL_SERVER = '192.168.124.51:1433'
# MSSQL_USER = 'spider'
...
SCHEDULER_JOBSTORES = {'default': RedisJobStore(password=195910, db=3, host='192.168.125.115')}
...
# # 业务员是否有客户权限
# CUSTOMER_PERMISSION = 'http://192.168.123.210:8000/api/services/Customer/Customer/IsCustomerPermission'
# # 通过用户获取客户编码Qcbm
# CUSTOMER_LIST = 'http://192.168.124.60:8000/api/services/Customer/Customer/GetCustomerCodeByUser'
